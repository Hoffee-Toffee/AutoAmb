...
export const layers = {
  drip: {
    ...
    intensity: {
      0: { volume: 0.1, solo_frequency: 0.1, norm_frequency: 0 },
      0.5: { volume: 0.5, solo_frequency: 0.25, norm_frequency: 0 },
      1: { volume: 1, solo_frequency: 0.5, norm_frequency: 0 },
      2: { volume: 3, solo_frequency: 0.5, norm_frequency: 0.5 },
    },
    variance: 0.1,
